...
import lemmatizadorWordnet as lw
...
def return_paragraph(origin,text):
	text = "(\A|\n)(" + re.sub(" "," *?",text[15:]) + ".*)\n"
...
if __name__ == "__main__":
	...
	print
	print sys.argv[1]
	print transform_from_url(sys.argv[1],"destiny_test.txt")
	print lw.NER_separation("destiny_test.txt")
